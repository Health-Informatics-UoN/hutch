...
- Resolve runs on Python version >= 3.9 and < 3.11
...
<Callout type="info">
  These instructions assume you have a dump of an OMOP-CDM database called
  `hutch_db.tar`
</Callout>
...
<Callout emoji="🎉">Congratulations on your first Resolve query!</Callout>
