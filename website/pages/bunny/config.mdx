...
| `OMOP_LOCATION_ENABLED`                         | 'boolean'                                              | Enable support for querying the OMOP Location table (geo-radius, source value, and country concept filters). Available from vX.Y | `false`      |
