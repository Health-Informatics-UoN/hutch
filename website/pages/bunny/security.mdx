...
- A SBOM for Bunny [is published](https://github.com/Health-Informatics-UoN/hutch-bunny/network/dependencies) providing visibility into dependencies and supply chain security.
