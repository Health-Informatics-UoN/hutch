...
<Tabs items={["Virtual Machine", "AWS EKS Terraform", "Kubernetes" ]}>
  <Tabs.Tab>
...
<Tabs.Tab>
  ...
  Health Informatics Centre (HIC) at the University of Dundee have open-sourced their Terraform for deploying Bunny in AWS Elastic Kubernetes Services (EKS).

  [Follow the guidance](https://github.com/hic-infra/bunny-deploy)

</Tabs.Tab>

<Tabs.Tab>

  We have sample [Kubernetes Helm charts](https://github.com/Health-Informatics-UoN/hutch/tree/main/charts/hutch) for deploying Bunny.

  It's early in our Kubernetes journey, so welcome feedback and patience as our documentation emerges. 
