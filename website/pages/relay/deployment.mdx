...
The sample enables Relay's GA4GH Beacon interface by default; you may wish to [configure it](/relay/config#ga4gh-beacon) more richly, or disable it.

If you want to use Relay with an Upstream Task API Query Source, you'll need to enable it and configure your [Upstream Task API host connection](/relay/config#upstream-task-api).
