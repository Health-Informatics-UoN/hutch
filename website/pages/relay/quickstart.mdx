...
The easiest way to run Relay is by using the provided [Relay Image](https://github.com/Health-Informatics-UoN/hutch-bunny/pkgs/container/hutch%2Frelay) configured to use the GA4GH Beacon API as a Query Source.
...
Here, Bunny 1 has returned `44` matching records; ff you check Bunny 2 you will see the same, as they are both using the same synthetic dataset.
