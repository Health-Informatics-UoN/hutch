...
Bunny is an application for fetching [Cohort Discovery](concepts/cohort_discovery) queries and resolving them against an OMOP database.
...
- Bunny currently supports PostgreSQL, SQL Server, Snowflake, and DuckDB as OMOP CDM databases.
